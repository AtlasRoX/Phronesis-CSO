...
- **Within the CSO**: `phronesis-cso` routes the single-cell sub-questions through this fetch → specificity chain. Output is a standard `.h5ad`, so it composes via the Bio Orchestrator.
