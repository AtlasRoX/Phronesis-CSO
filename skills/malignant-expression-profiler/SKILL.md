...
- Within `phronesis-cso` it serves Target ID & Target Safety (the malignant-vs-stromal/normal question). Output is structured JSON, so it chains via the Bio Orchestrator.
