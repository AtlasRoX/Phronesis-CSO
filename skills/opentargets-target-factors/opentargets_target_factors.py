...
and **safety liabilities** in a single GraphQL call, and map them to the Phronesis
CSO divisions they inform:
...
# Which Phronesis CSO division each prioritisation key informs.
FACTOR_DIVISION = {
...
# --------------------------------------------------------------------------- #
def _ot_query(query: str, timeout: int = 15) -> dict[str, Any]:
...
def map_factors(target: dict[str, Any]) -> dict[str, Any]:
    """Group OT factors by the Phronesis CSO division they inform."""
