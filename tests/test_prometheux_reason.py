"""Tests for skills/phronesis-cso/prometheux_reason.py — the Vadalog reasoning layer.
...
SKILL = Path(__file__).resolve().parents[1] / "skills" / "phronesis-cso"
sys.path.insert(0, str(SKILL))

import kg as KG  # type: ignore # noqa: E402
import prometheux_reason as pr  # type: ignore # noqa: E402
...
def test_forcing_gap_overrides_vote_threshold() -> None:
    ...
    import cso  # type: ignore  # noqa: PLC0415
